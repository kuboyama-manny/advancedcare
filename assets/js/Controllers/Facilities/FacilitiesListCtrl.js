...
// Facilities List Controller
angular.module('app').controller('FacilitiesListCtrl', ['$scope', '$stateParams', 'APIService',
    function ($scope, $stateParams, APIService) {
        ...
        $scope.loadData = function () {
            ...
            var url = request === ''? '/facility?' : '/facility?q=' + request + "&";
            ...
            APIService.get(url + 'count=' + $scope.page_size + '&page=' + $scope.current_page).then(function (response) {
                ...
                $scope.facilities = response.result;
